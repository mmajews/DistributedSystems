...
public abstract class EvictorBase implements Ice.ServantLocator {
    private Map<Identity, EvictorEntry> _map = new HashMap<Identity, EvictorEntry>();
    private server.evictor.LinkedList<Ice.Identity> _queue = new server.evictor.LinkedList<Ice.Identity>();
    private int _size;
